...
const SECTIONS = new Map([
	...
	['`GET /fhir/metadata`', 'metadata.md'],
	['`POST /fhir/$formulary-session`', 'formulary-session.md'],
	['`POST /fhir/$createrx-session`', 'createrx-session.md'],
	['`GET /fhir/$session-result`', 'session-result.md'],
